...
(function() {
  'use strict';
  angular.module('BBAdminDashboard.calendar.controllers').controller('bbResourceCalendarController', function($scope, $rootScope, $attrs, BBAssets, ProcessAssetsFilter, $state, GeneralOptions, AdminCalendarOptions, CalendarEventSources, TitleAssembler, $translate, uiCalendarConfig, AdminCompanyService, $q, ModalForm, AdminBookingPopup, AdminMoveBookingPopup, $window, $bbug, Dialog, $filter, PrePostTime, BBModel) {
    ...
    isTimeRangeAvailable = function(start, end, resource) {
      ...
      events = uiCalendarConfig.calendars[$scope.calendar_name].fullCalendar('clientEvents', function(event) {
    ...
    $scope.changeSelectedResources = function() {
      ...
      return uiCalendarConfig.calendars[$scope.calendar_name].fullCalendar('refetchEvents');
    };
    $scope.getCompanyPromise().then(function(company) {
      $scope.loading = true;
    ...
    $scope.refreshBooking = function(booking) {
      return booking.$refetch().then(function(response) {
        ...
        return uiCalendarConfig.calendars[$scope.calendar_name].fullCalendar('updateEvent', booking);
      });
    };
        ...
        success: (function(_this) {
          return function(response) {
            ...
            if (response.is_cancelled) {
              return uiCalendarConfig.calendars[$scope.calendar_name].fullCalendar('removeEvents', [response.id]);
            } else {
              booking.title = getBookingTitle(booking);
              return uiCalendarConfig.calendars[$scope.calendar_name].fullCalendar('updateEvent', booking);
            }
    ...
    $scope.updateDate = function(date) {
      ...
      if (uiCalendarConfig.calendars[$scope.calendar_name]) {
        ...
        return uiCalendarConfig.calendars[$scope.calendar_name].fullCalendar('gotoDate', assembledDate);
      }
    };
...
(function() {
  'use strict';
  angular.module('BBAdminDashboard.calendar.directives').directive('bbResourceCalendar', function(BBModel, ColorPalette, $timeout, $compile, $templateCache) {
    var link;
...
(function() {
  ...
  angular.module('BBAdminDashboard.check-in.directives').directive('bbAddWalkin', function() {
    return {
      ...
      scope: true,
      link: function(scope, element, attrs) {},
      controller: function($scope, AdminBookingPopup, $timeout) {
...
(function() {
   ...
   */
  angular.module('BBAdminDashboard').directive('adminIframe', [
  ...
  angular.module('BBAdminDashboard').directive('adminSideNav', [
    function() {
      return {
        ...
        controller: [
          '$scope', 'SideNavigationPartials', function($scope, SideNavigationPartials) {
...
(function() {
  angular.module('BBAdminDashboard').directive('bbAdminDashboard', function(PageLayout) {
    return {
      ...
      controller: [
        '$scope', '$rootScope', '$element', '$compile', '$localStorage', '$state', 'PageLayout', 'BBModel', 'AdminSsoLogin', 'AdminLoginOptions', function($scope, $rootScope, $element, $compile, $localStorage, $state, PageLayout, BBModel, AdminSsoLogin, AdminLoginOptions) {
          var api_url;
...
(function() {
   ...
   */
  angular.module('BBAdminDashboard').directive('bodyResize', [
    '$window', '$timeout', 'AdminCoreOptions', 'PageLayout', function($window, $timeout, AdminCoreOptions, PageLayout) {
      return {
        restrict: 'A',
...
(function() {
   ...
   */
  angular.module('BBAdminDashboard').directive('contentHeight', [
    '$window', '$timeout', function($window, $timeout) {
      return {
        restrict: 'A',
...
(function() {
  angular.module('BBAdminDashboard').factory('AdminSsoLogin', [
    'halClient', '$q', function(halClient, $q) {
      return {
        ssoToken: null,
        companyId: null,
        apiUrl: null,
...
(function() {
  ...
  *
  ...
  angular.module('BBAdminDashboard').factory('PageLayout', [
    'AdminCoreOptions', function(AdminCoreOptions) {
      return {
...
(function() {
  ...
  * @example
   ...
   */
  angular.module('BBAdminDashboard').provider('RuntimeRoutes', [
...
(function() {
  ...
  * @example
   ...
   */
  angular.module('BBAdminDashboard').provider('RuntimeStates', [
...
(function() {
  ...
  * Controller for the login page
  ...
  angular.module('BBAdminDashboard.login.controllers').controller('LoginPageCtrl', [
    '$scope', '$state', 'AdminLoginService', 'AdminCoreOptions', 'user', function($scope, $state, AdminLoginService, AdminCoreOptions, user) {
      $scope.user = user;
...
(function() {
  ...
  *
  ...
  angular.module('BBAdminDashboard.login.services').factory('LoggedAdmin', [
    'AdminLoginOptions', '$q', function(AdminLoginOptions, $q) {
      var loggedAdmin;
      loggedAdmin = {
        user: null,
